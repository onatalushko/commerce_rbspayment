...
class CommerceRbsPaymentApi {
  ...
  private $rbsApiTestUrl = 'https://web.rbsuat.com/ab/rest/';
  private $rbsApiProdUrl = 'https://engine.paymentgate.ru/payment/rest/';
  ...
  protected function callMethod($method_url_suffix, array $data = array()) {
    try {
      ...
      $fp = fopen("{$this->serverUrl}{$method_url_suffix}", 'rb', FALSE, $stream_context);
      if (!$fp) {
